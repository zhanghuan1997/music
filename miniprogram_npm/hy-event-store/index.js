...
__DEFINE__(1684373641560, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1684373641561,"./event-store":1684373641562}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1684373641561, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1684373641562, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1684373641561,"./utils":1684373641563}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1684373641563, function(require, module, exports) {
...
return __REQUIRE__(1684373641560);
})()
